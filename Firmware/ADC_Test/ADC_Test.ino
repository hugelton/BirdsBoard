/*
 * ADC_Test - Hardware Debugging and Calibration Utility
...
// Includes BirdsBoard-style FIR filtering for comparison
...
// ADC range calibration (from CLAUDE.md/BirdsBoard)
...
void setup() {
  ...
  Serial.println("=== BirdsBoard ADC Test with BirdsBoard Filtering ===");
...
void loop() {
  ...
  // Apply BirdsBoard-style filtering
...
// BirdsBoard-style ADC filter functions
